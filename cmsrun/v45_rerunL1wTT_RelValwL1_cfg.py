...
# with command line options: l1nanoPhase2 -s L1TrackTrigger,L1,L1P2GT,NANO:@Phase2L1DPGwithGen --processName L1TReRun --conditions auto:phase2_realistic --geometry ExtendedRun4D121 --era Phase2C17I13M9 --eventcontent NANOAOD --datatier GEN-SIM-DIGI-RAW-MINIAOD --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring,L1Trigger/Configuration/customisePhase2TTOn110.customisePhase2TTOn110 --procModifiers nano_l1_hlt --filein /store/relval/CMSSW_20_0_0_pre1/RelValTTbar_14TeV/GEN-SIM-DIGI-RAW/PU_150X_mcRun4_realistic_v1_STD_D121_RegeneratedGS_PU-v1/2590000/0033230b-a131-453a-95c0-fe14d5027d1f.root --fileout file:output_Phase2_L1T.root --python_filename v45_rerunL1wTT_RelValwL1_cfg.py --customise_commands 'process.finalGenParticles.src = '"'"'genParticles'"'"'\nprocess.genJetTable.src = '"'"'ak4GenJetsNoNu'"'"'\ndelattr(process.genParticleTable.externalVariables,'"'"'iso'"'"')\ndel process.genIso\ndel process.genJetFlavourTable\ndel process.patJetPartonsNano\nimport FWCore.ParameterSet.Config as cms; from PhysicsTools.NanoAOD.simpleSingletonCandidateFlatTableProducer_cfi import simpleSingletonCandidateFlatTableProducer; from PhysicsTools.NanoAOD.common_cff import PTVars; process.metMCTable = simpleSingletonCandidateFlatTableProducer.clone(src='"'"'genMetTrue'"'"', name='"'"'GenMET'"'"', doc='"'"'Gen MET'"'"', variables=cms.PSet(PTVars)); from PhysicsTools.NanoAOD.jetMC_cff import genJetAK8Table as _ak8; process.genJetAK8Table = _ak8.clone(src='"'"'ak8GenJetsNoNu'"'"', doc='"'"'AK8 gen jets (no nu)'"'"', cut='"'"'pt > 10'"'"'); process.genExtra_step = cms.Path(process.metMCTable + process.genJetAK8Table); process.schedule.append(process.genExtra_step)' '--inputCommands=keep *, drop l1tPFJets_*_*_*, drop l1tTrackerMuons_l1tTkMuonsGmt*_*_HLT' --mc -n 40 --nThreads 4
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C17I13M9_cff import Phase2C17I13M9
from Configuration.ProcessModifiers.nano_l1_hlt_cff import nano_l1_hlt

process = cms.Process('L1TReRun',Phase2C17I13M9,nano_l1_hlt)
